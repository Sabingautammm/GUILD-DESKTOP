...
interface ModeStatsCardProps {
  ...
  title: string;
  stats: ModeStats;
  /** Icon shown inside the rank-points badge — differs per mode (e.g. a point
   * icon for BR Rank, a star for CS Rank). Ignored if stats.rankPoints is unset. */
  rankPointsIcon?: IconType;
  /** Label after the number in the badge. Defaults to "Points". */
...
function ModeStatsCard({
  ...
  title,
  stats,
  rankPointsIcon: RankIcon,
  rankPointsLabel = "Points",
}: ModeStatsCardProps) {
  return (
